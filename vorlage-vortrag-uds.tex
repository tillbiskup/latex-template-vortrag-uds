...
\input{LaTeX-Header/mathematik.tex}
\input{LaTeX-Header/typografie.tex}
\input{LaTeX-Header/layout.tex}
\input{LaTeX-Header/listings.tex}
\input{LaTeX-Header/grafiken.tex}
...
\usetheme[titlepagepic=false]{UdS}

%% Muss nach dem "\usetheme" erscheinen, weil die Farben geändert werden
\input{LaTeX-Header/beamer-uds-changes}
